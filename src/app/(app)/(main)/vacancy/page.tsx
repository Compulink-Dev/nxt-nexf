...
const jobListings = [
  {
    ...
    deadline: '2024-02-15',
    description:
      'We are seeking an experienced Senior Economist to lead our research initiatives. The ideal candidate will have a strong background in macroeconomic analysis and policy research.',
    responsibilities: [
      'Lead economic research projects and policy analysis',
      'Conduct macroeconomic forecasting and analysis',
      'Mentor junior research team members',
      'Present findings to stakeholders and government officials',
      'Contribute to policy briefs and working papers',
    ],
    requirements: [
      'PhD in Economics or related field',
      '5+ years of professional experience in economic research',
      'Strong analytical and quantitative skills',
      'Excellent written and verbal communication',
      'Experience with econometric modeling and data analysis',
    ],
    benefits: [
  ...
  },
  {
    ...
    deadline: '2024-02-20',
    description:
      'Join our research team as a Research Analyst focusing on trade policy and industrial development. You will support senior economists in conducting research and analysis.',
    responsibilities: [
      'Conduct literature reviews and data analysis',
      'Assist in designing and executing research projects',
      'Prepare research reports and policy briefs',
      'Support dialogue organization and event management',
    ...
    requirements: [
      ...
      'Proficiency in Excel, R, or Python for data analysis',
  ...
  },
  {
    ...
    deadline: '2024-02-18',
    description:
      'Design and implement capacity building programs that enhance skills in economic analysis and policy development across the public and private sectors.',
    responsibilities: [
...
function VacancyPage() {
  ...
  const filteredJobs = useMemo(
    ...
    [searchQuery, selectedDepartment, selectedJobType, selectedExperience],
  )
